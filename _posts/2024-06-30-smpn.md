---
layout: distill
title: Applications of TopoX to Equivariant Topological Deep Learning
description: Studying the properties of message passing accross equivariant topological neural networks using the TopoX Suite
tags: TDL, GDL
